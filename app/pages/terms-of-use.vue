...
useSEO({
  title: t('pages.terms_of_use.seo.title'),
  description: t('pages.terms_of_use.seo.description')
}) 

const sections = computed(() => tm('pages.terms_of_use.sections') as any[])
</script>
    ...
    <div class="container-custom max-w-4xl mx-auto">
      ...
      <div class="bg-white rounded-3xl p-8 md:p-12 shadow-sm">
        <h1 class="text-3xl md:text-4xl font-heading font-bold text-dark-900 mb-8">
          {{ t('pages.terms_of_use.title') }}
        </h1>
        <p class="text-lg text-dark-500 mb-8 italic">
          {{ t('pages.terms_of_use.subtitle') }}
        </p>
